...
internal object StaminaMovementLogic {
   public fun axisFor(hole: jooon.features.dojo.StaminaMovementLogic.HoleBox): jooon.features.dojo.StaminaMovementLogic.Axis {
      return if (hole.xSize <= hole.zSize) StaminaMovementLogic.Axis.X else StaminaMovementLogic.Axis.Z
   }

   public fun axisFor(direction: jooon.features.dojo.StaminaMovementLogic.HoleDirection, hole: jooon.features.dojo.StaminaMovementLogic.HoleBox): jooon.features.dojo.StaminaMovementLogic.Axis {
   ...
   public fun directionFromPrevious(
   ...
   public fun entryApproachTarget(
      axis: jooon.features.dojo.StaminaMovementLogic.Axis,
      center: jooon.features.dojo.StaminaMovementLogic.Point,
      entrySide: Double,
      distance: Double
   ...
   public fun planHole(
      ...
      if (!this.isIncoming(hole, direction, player)) {
         ...
         val entrySide: Double = this.entrySideFor(axis, direction, player, center)
var var10000: Double
         when (StaminaMovementLogic.WhenMappings.$EnumSwitchMapping$1[axis.ordinal()]) {
   ...
   public fun shouldBrakeAfterJumpPass(
      pass: jooon.features.dojo.StaminaMovementLogic.Pass,
      player: jooon.features.dojo.StaminaMovementLogic.Point,
   ...
   public fun shouldRefreshActivePass(
      pass: jooon.features.dojo.StaminaMovementLogic.Pass,
      player: jooon.features.dojo.StaminaMovementLogic.Point,
   ...
   public fun isRecentlyPassedWall(
      axis: jooon.features.dojo.StaminaMovementLogic.Axis,
      center: jooon.features.dojo.StaminaMovementLogic.Point,
      player: jooon.features.dojo.StaminaMovementLogic.Point,
   ...
   public fun nearestMatchingPassHole(
      pass: jooon.features.dojo.StaminaMovementLogic.Pass,
      ...
      for (hole in holes) {
         if (this.axisFor(hole) === pass.axis) {
            val distance: Double = this.horizontalDistance(hole.center, pass.center)
   ...
   public fun shouldMoveOnGapRoute(routeHasGap: Boolean, jumpPressed: Boolean, forwardFloorSafe: Boolean): Boolean {
      return !routeHasGap || jumpPressed || forwardFloorSafe
   }

   public fun shouldStartJumpForRoute(
      highHole: Boolean,
   ...
   public fun scanGap(floorSamples: List<Boolean>, sampleStep: Double, maxGapWidth: Double, firstSampleDistance: Double = 0.0): jooon.features.dojo.StaminaMovementLogic.GapScan {
      ...
      while (start.hasNext()) {
         val index: Int = width++
         if (!start.next() as java.lang.Boolean) {
            if (gapStart == null) {
               gapStart = index
            }
      ...
      if (gapStart == null) {
         ...
         val var17: Int = gapStart
         return StaminaMovementLogic.GapScan(
            sawFloorAfterGap && (gapEnd - var17 + 1) * sampleStep <= maxGapWidth,
            sawFloorAfterGap && (gapEnd - var17 + 1) * sampleStep <= maxGapWidth,
            firstSampleDistance + (double)var17 * sampleStep
         )
      }
   }

   public fun exactFloorOrFallback(x: Int, z: Int, exactFloorY: Int?, fallbackTopFloorY: Int, hasSolidFloor: (Int, Int, Int) -> Boolean): Boolean {
      if (exactFloorY != null) {
         return hasSolidFloor(x, exactFloorY, z) as java.lang.Boolean
      } else {
         for (dy in 0 downTo -2) {
            if (hasSolidFloor(x, fallbackTopFloorY + dy, z) as java.lang.Boolean) {
               return true
            }
         }
   ...
   public enum class ApproachPhase {
      ALIGN_LATERAL,
      STAGE_FOR_JUMP,
      PASS_THROUGH;
   ...
   public data class GapScan(hasShortJumpableGap: Boolean, routeAcceptable: Boolean, firstGapStartDistance: Double? = null) {
      public final val hasShortJumpableGap: Boolean
      public final val routeAcceptable: Boolean
      public final val firstGapStartDistance: Double?
   ...
   public data class HoleBox(minX: Double, maxX: Double, minZ: Double, maxZ: Double) {
      public final val minX: Double
      public final val maxX: Double
      public final val minZ: Double
      public final val maxZ: Double
      ...
      public final val xSize: Double
         public final get() {
            return this.maxX - this.minX
         }


      public final val zSize: Double
         public final get() {
            return this.maxZ - this.minZ
         }


      public final val center: jooon.features.dojo.StaminaMovementLogic.Point
         public final get() {
            return StaminaMovementLogic.Point((this.minX + this.maxX) * 0.5, (this.minZ + this.maxZ) * 0.5)
         }


      public fun move(dx: Double, dz: Double): jooon.features.dojo.StaminaMovementLogic.HoleBox {
      ...
      public fun copy(minX: Double = this.minX, maxX: Double = this.maxX, minZ: Double = this.minZ, maxZ: Double = this.maxZ): jooon.features.dojo.StaminaMovementLogic.HoleBox {
   ...
   public enum class HoleDirection {
      POSITIVE_X,
      POSITIVE_Z,
      NEGATIVE_X,
      NEGATIVE_Z,
   ...
   public data class Pass(axis: jooon.features.dojo.StaminaMovementLogic.Axis, center: jooon.features.dojo.StaminaMovementLogic.Point, entrySide: Double) {
      public final val axis: jooon.features.dojo.StaminaMovementLogic.Axis
      public final val center: jooon.features.dojo.StaminaMovementLogic.Point
   ...
   public data class PlannedHole(hole: jooon.features.dojo.StaminaMovementLogic.HoleBox,
      direction: jooon.features.dojo.StaminaMovementLogic.HoleDirection,
      axis: jooon.features.dojo.StaminaMovementLogic.Axis,
      ...
      public final val hole: jooon.features.dojo.StaminaMovementLogic.HoleBox
      public final val direction: jooon.features.dojo.StaminaMovementLogic.HoleDirection
      public final val axis: jooon.features.dojo.StaminaMovementLogic.Axis
      public final val phase: jooon.features.dojo.StaminaMovementLogic.ApproachPhase
      public final val center: jooon.features.dojo.StaminaMovementLogic.Point
      public final val target: jooon.features.dojo.StaminaMovementLogic.Point
      public final val entrySide: Double
   ...
   public data class Point(x: Double, z: Double) {
      ...
      public fun copy(x: Double = this.x, z: Double = this.z): jooon.features.dojo.StaminaMovementLogic.Point {
