...
public object JerryAlert {
   ...
   private fun handleChatMessage(message: String) {
      ...
      if (var10000 != null) {
         val var8: java.lang.String = StringsKt.trim(var10000.getGroupValues().get(1) as java.lang.String).toString().toLowerCase(Locale.ROOT)
var var9: JerryAlert.JerryType
   ...
   private fun showAlert(jerryType: jooon.features.jerry.JerryAlert.JerryType, originalMessage: String) {
      ...
      val var10000: MutableText = Text.method_43470("JERRY!").method_27692(Formatting.field_1060)
      val var5: MutableText = Text.method_43470(jerryType.displayName).method_27692(jerryType.getFormatting())
      this.getMc().field_1705.method_34004(var10000 as Text)
      this.getMc().field_1705.method_34002(var5 as Text)
   }

   private fun playNotificationSound() {
      if (Config.jerryAlertSoundEnabled) {
         val var10000: PositionedSoundInstance = PositionedSoundInstance.method_47978(SoundEvents.field_14622 as RegistryEntry, 2.0F)
         this.getMc().method_1483().method_4873(var10000 as SoundInstance)
      }
   }

   public fun testAlert(jerryTypeName: String) {
      val var10000: java.lang.String = jerryTypeName.toLowerCase(Locale.ROOT)
var var5: JerryAlert.JerryType
   ...
   private enum class JerryType {
      GREEN("Green Jerry", Formatting.field_1060),
      BLUE("Blue Jerry", Formatting.field_1078),
      PURPLE("Purple Jerry", Formatting.field_1064),
      GOLDEN("Golden Jerry", Formatting.field_1065);

      public final val displayName: String
      private Formatting formatting;

      fun JerryType(displayName: java.lang.String, formatting: Formatting) {
