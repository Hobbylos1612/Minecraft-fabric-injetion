...
private object VoxelPathProgress {
   ...
   fun withinReach(target: Vec3d, pos: Vec3d, isSky: Boolean, yReach: Double): Boolean {
      val planarDist: Double = Math.hypot(pos.field_1352 - target.field_1352, pos.field_1350 - target.field_1350)
      if (isSky)
         Math.hypot(planarDist, pos.field_1351 - target.field_1351) < 0.8
         else
   ...
   fun crossedSegmentPlane(waypoints: MutableList<Vec3d>, index: Int, target: Vec3d, pos: Vec3d): Boolean {
      ...
      if (var10000 == null) {
         ...
         val segmentLen: Double = Math.hypot(var10000.field_1352, var10000.field_1350)
         segmentLen != 0.0
