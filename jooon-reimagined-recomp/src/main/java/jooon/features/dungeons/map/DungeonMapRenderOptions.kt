...
data class DungeonMapRenderOptions(colors: Map<DungeonMapColors, Color>,
   roomWidth: Double,
   doorWidth: Double,
   dungeonWidth: Int,
   dungeonHeight: Int,
   ...
   val unknownRoomsDarkenFactor: Double
   ...
   fun copy(
      ...
      return DungeonMapRenderOptions(
         ...
         renderUnknownRooms,
         dungeonStarted,
return unknownRoomsDarkenFactor
      )
   }
